...
function AuthenticatedLayout() {
    const { user } = Route.useRouteContext(); // guaranteed non-null

    return (
        <div className="min-h-screen flex bg-neutral-950 text-neutral-50">
            {/* Sidebar */}
            <aside className="hidden md:flex w-60 flex-col border-r border-neutral-800 bg-black/40 backdrop-blur-sm px-4 py-4 gap-4">
          ...
          <span className="text-[10px] uppercase tracking-[0.16em] text-neutral-500 mb-1">
            Navigation
                    ...
                    <div className="rounded-lg px-2 py-1 bg-neutral-900/80 text-neutral-100 text-xs">
                        Dashboard
                    </div>
